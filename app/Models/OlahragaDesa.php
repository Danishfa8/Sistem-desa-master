 ...
 * @property $tahun
 * @property $jenis_olahraga
 * @property $nama_kelompok_olahraga
 * @property $created_by
 * @property $updated_by
 * @property $status
 ...
 */
class OlahragaDesa extends Model
{
    /**
     ...
     */
    protected $fillable = ['id_kategori','desa_id', 'rt_rw_desa_id', 'tahun', 'jenis_olahraga', 'nama_kelompok_olahraga', 'created_by', 'updated_by', 'status', 'reject_reason', 'approved_by', 'approved_at'];
