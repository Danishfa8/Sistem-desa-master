 ...
 * @property $tahun
 * @property $jenis_sarana_lainnya
 * @property $nama_sarana_lainnya
 * @property $created_by
 * @property $updated_by
 * @property $status
 ...
 */
class SaranaLainyaDesa extends Model
{
    /**
     ...
     */
    protected $fillable = ['id_kategori','desa_id', 'rt_rw_desa_id', 'tahun', 'jenis_sarana_lainnya', 'nama_sarana_lainnya', 'created_by', 'updated_by', 'status', 'reject_reason', 'approved_by', 'approved_at'];
