...
/**
 * Class PelakuUmkmDesa
 *
 * @property $id
 * @property $desa_id
 * @property $rt_rw_desa_id
 * @property $tahun
 * @property $jenis_pelaku_umkm
 * @property $created_by
 * @property $updated_by
 * @property $status
 ...
 */
class PelakuUmkmDesa extends Model
{
     ...
     */
    protected $fillable = ['desa_id', 'rt_rw_desa_id', 'tahun', 'jumlah_umkm', 'created_by', 'updated_by', 'status', 'reject_reason', 'approved_by', 'approved_at'];
