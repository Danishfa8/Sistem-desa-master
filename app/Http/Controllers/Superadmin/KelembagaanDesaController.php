...
class KelembagaanDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.kelembagaan-desa.index', compact('kelembagaanDesas'))
    ...
    public function store(KelembagaanDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.kelembagaan-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.kelembagaan-desa.show', compact('kelembagaanDesa'));
    }
