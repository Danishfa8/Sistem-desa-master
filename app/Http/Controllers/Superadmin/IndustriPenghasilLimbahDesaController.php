...
class IndustriPenghasilLimbahDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.industri-penghasil-limbah-desa.index', compact('industriPenghasilLimbahDesas'))
    ...
    public function store(IndustriPenghasilLimbahDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.industri-penghasil-limbah-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.industri-penghasil-limbah-desa.show', compact('industriPenghasilLimbahDesa'));
    }
