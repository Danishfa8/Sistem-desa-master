...
class SumberDayaAlamDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.sumber-daya-alam-desa.index', compact('sumberDayaAlamDesas'))
    ...
    public function store(SumberDayaAlamDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.sumber-daya-alam-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.sumber-daya-alam-desa.show', compact('sumberDayaAlamDesa'));
    }
