...
class KondisiLingkunganKeluargaDesaController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('superadmin.kondisi-lingkungan-keluarga-desa.create', compact('kategoris','kondisiLingkunganKeluargaDesa', 'desas'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.kondisi-lingkungan-keluarga-desa.edit', compact('kategoris','kondisiLingkunganKeluargaDesa', 'desas'));
    }
