...
class TransportasiDesa extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.transportasi.index', compact('transportasi'))
    ...
    public function store(TransportasiRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.transportasi.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.transportasi.show', compact('transportasi'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.transportasi.edit', compact('kategoris','transportasi', 'desas'));
    }
