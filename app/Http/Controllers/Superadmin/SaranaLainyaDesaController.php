...
class SaranaLainyaDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.sarana-lainya-desa.index', compact('saranaLainyaDesas'))
    ...
    public function store(SaranaLainyaDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.sarana-lainya-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.sarana-lainya-desa.show', compact('saranaLainyaDesa'));
    }
