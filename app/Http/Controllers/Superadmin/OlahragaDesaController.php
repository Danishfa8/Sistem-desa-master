...
class OlahragaDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.olahraga-desa.index', compact('olahragaDesas'))
    ...
    public function store(OlahragaDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.olahraga-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.olahraga-desa.show', compact('olahragaDesa'));
    }
