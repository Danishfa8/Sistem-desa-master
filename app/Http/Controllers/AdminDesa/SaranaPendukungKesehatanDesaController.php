...
class SaranaPendukungKesehatanDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin_desa.sarana-pendukung-kesehatan-desa.index', compact('saranaPendukungKesehatanDesas'))
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.sarana-pendukung-kesehatan-desa.create', compact('kategoris','saranaPendukungKesehatanDesa', 'desas'));
    }
    ...
    public function store(SaranaPendukungKesehatanDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('admin_desa.sarana-pendukung-kesehatan-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('admin_desa.sarana-pendukung-kesehatan-desa.show', compact('saranaPendukungKesehatanDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.sarana-pendukung-kesehatan-desa.edit', compact('kategoris','saranaPendukungKesehatanDesa', 'desas'));
    }
