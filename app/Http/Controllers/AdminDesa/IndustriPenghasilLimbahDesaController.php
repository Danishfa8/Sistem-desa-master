...
class IndustriPenghasilLimbahDesaController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.industri-penghasil-limbah-desa.create', compact('kategoris','industriPenghasilLimbahDesa', 'desas'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.industri-penghasil-limbah-desa.edit', compact('kategoris','industriPenghasilLimbahDesa', 'desas'));
    }
