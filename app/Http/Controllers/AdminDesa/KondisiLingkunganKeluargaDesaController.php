...
class KondisiLingkunganKeluargaDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin_desa.kondisi-lingkungan-keluarga-desa.index', compact('kondisiLingkunganKeluargaDesas'))
    ...
    public function store(KondisiLingkunganKeluargaDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('admin_desa.kondisi-lingkungan-keluarga-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('admin_desa.kondisi-lingkungan-keluarga-desa.show', compact('kondisiLingkunganKeluargaDesa'));
    }
