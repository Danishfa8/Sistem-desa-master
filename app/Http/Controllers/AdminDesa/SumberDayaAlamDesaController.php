...
class SumberDayaAlamDesaController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.sumber-daya-alam-desa.create', compact('kategoris','sumberDayaAlamDesa', 'desas'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.sumber-daya-alam-desa.edit', compact('kategoris','sumberDayaAlamDesa', 'desas'));
    }
