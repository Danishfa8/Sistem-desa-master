...
class KelembagaanDesaController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.kelembagaan-desa.create', compact('kategoris','kelembagaanDesa', 'desas', 'rtRwDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.kelembagaan-desa.edit', compact('kategoris','kelembagaanDesa', 'desas'));
    }
