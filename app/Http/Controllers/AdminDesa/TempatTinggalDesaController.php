...
class TempatTinggalDesaController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.tempat-tinggal-desa.create', compact('kategoris','tempatTinggalDesa', 'desas'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.tempat-tinggal-desa.edit', compact('kategoris','tempatTinggalDesa', 'desas'));
    }
