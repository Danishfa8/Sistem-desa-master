...
class UsahaEkonomiController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.usaha-ekonomi.create', compact('kategoris','usahaEkonomi', 'desas'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.usaha-ekonomi.edit', compact('kategoris','usahaEkonomi'));
    }
