...
class OlahragaDesaController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.olahraga-desa.create', compact('kategoris','olahragaDesa', 'desas'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.olahraga-desa.edit', compact('kategoris','olahragaDesa', 'desas'));
    }
