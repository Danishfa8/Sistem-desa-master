    ...
    <div class="col-md-12">
            ...
            <select name="desa_id" id="desa_id" class="form-control select2 @error('desa_id') is-invalid @enderror">
                ...
                @foreach ($desas as $item)
                    <option value="{{ $item->id }}"
                        {{ old('desa_id', $lansiaDesa?->desa_id) == $item->id ? 'selected' : '' }}>
                        {{ $item->nama_desa }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" name="tahun" class="form-control @error('tahun') is-invalid @enderror"
                value="{{ old('tahun', $lansiaDesa?->tahun) }}" id="tahun" placeholder="Tahun">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" name="jumlah_lansia" class="form-control @error('jumlah_lansia') is-invalid @enderror"
                value="{{ old('jumlah_lansia', $lansiaDesa?->jumlah_lansia) }}" id="jumlah_lansia" placeholder="Masukkan Jumlah Lansia">
