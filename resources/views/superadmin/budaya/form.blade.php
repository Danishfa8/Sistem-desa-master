    ...
    <div class="col-md-12">
        ...
        <div class="form-group mb-2">
            ...
            <select name="id_kategori" id="id_kategori" class="form-control select2 @error('id_kategori') is-invalid @enderror">
                ...
                <option value="{{ $kategori->id }}"
                    {{ old('id_kategori', $budayas?->id_kategori) == $kategori->id ? 'selected' : '' }}>
                    {{ $kategori->nama }}
                </option>
                @endforeach
            </select>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <select name="desa_id" id="desa_id" class="form-control select2 @error('desa_id') is-invalid @enderror">
                ...
                <option value="{{ $item->id }}"
                    {{ old('desa_id', $budayas?->desa_id) == $item->id ? 'selected' : '' }}>
                    {{ $item->nama_desa }}
                </option>
                @endforeach
            </select>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" name="tahun" class="form-control @error('tahun') is-invalid @enderror"
                value="{{ old('tahun', $budayas?->tahun) }}" id="tahun" placeholder="Contoh: 2025" min="1900" max="{{ date('Y') + 5 }}">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <select name="jenis_kebudayaan" class="form-control @error('jenis_kebudayaan') is-invalid @enderror" id="jenis_kebudayaan">
                ...
                <option value="Kesenian/Budaya" {{ old('jenis_kebudayaan', $budayas?->jenis_kebudayaan) == 'Kesenian/Budaya' ? 'selected' : '' }}>
                    Kesenian/Budaya
                </option>
                <option value="Cagar Budaya"
                    {{ old('jenis_kebudayaan', $budayas?->jenis_kebudayaan) == 'Cagar Budaya' ? 'selected' : '' }}>
                    Cagar Budaya
                </option>
                <option value="Gallery Seni & Souvenir" {{ old('jenis_kebudayaan', $budayas?->jenis_kebudayaan) == 'Gallery Seni & Souvenir' ? 'selected' : '' }}>
                    Gallery Seni & Souvenir
                </option>
                <option value="Penginapan" {{ old('jenis_kebudayaan', $budayas?->jenis_kebudayaan) == 'Penginapan' ? 'selected' : '' }}>
                    Penginapan
                </option>
                <option value="Tempat Wisata" {{ old('jenis_kebudayaan', $budayas?->jenis_kebudayaan) == 'Tempat Wisata' ? 'selected' : '' }}>
                    Tempat Wisata
                </option>
            </select>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="nama_kebudayaan" class="form-control @error('nama_kebudayaan') is-invalid @enderror"
                value="{{ old('nama_kebudayaan', $budayas?->nama_kebudayaan) }}" id="nama_kebudayaan" placeholder="Nama kebudayaan">
