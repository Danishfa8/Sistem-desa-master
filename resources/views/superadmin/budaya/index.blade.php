                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                <a href="{{ route('superadmin.budaya.create') }}" class="btn btn-primary btn-sm float-right"
                                    data-placement="left">
                                    {{ __('Create New') }}
                                </a>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($budayas as $budaya)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('superadmin.budaya.destroy', $budaya->id) }}"
                                                    method="POST">
                                                    <button type="button" class="btn btn-sm btn-primary"
                                                        ...
                                                        href="{{ route('superadmin.budaya.edit', $budaya->id) }}"><i
