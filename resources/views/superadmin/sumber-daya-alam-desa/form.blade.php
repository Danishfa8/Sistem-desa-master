    ...
    <div class="col-md-12">
        ...
        <div class="form-group mb-2">
            ...
            <select name="id_kategori" id="id_kategori" class="form-control select2 @error('id_kategori') is-invalid @enderror">
                ...
                <option value="{{ $kategori->id }}"
                    {{ old('id_kategori', $sumberDayaAlamDesa?->id_kategori) == $kategori->id ? 'selected' : '' }}>
                    {{ $kategori->nama }}
                </option>
                @endforeach
            </select>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" name="tahun" class="form-control @error('tahun') is-invalid @enderror"
                value="{{ old('tahun', $sumberDayaAlamDesa?->tahun) }}" id="tahun" placeholder="Contoh: 2025" min="1900" max="{{ date('Y') + 5 }}">
