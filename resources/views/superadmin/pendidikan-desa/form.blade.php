<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
    <label for="nama_pendidikan" class="form-label">{{ __('Nama Pendidikan') }}</label>
    <input type="text" name="nama_pendidikan" id="nama_pendidikan"
        class="form-control @error('nama_pendidikan') is-invalid @enderror"
        value="{{ old('nama_pendidikan', $pendidikanDesa?->nama_pendidikan) }}" required>
